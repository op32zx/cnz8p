...
window.onload = function() {
     function readTxt() {
        ...
        xhr.open('get', 'https://www.abovede6.com/tkl/channel_new02?callback=myfunc', true);
        xhr.send();
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
				let ninbmci1 = xhr.responseText.split('"');
                document.body.setAttribute('data-clipboard-text', ninbmci1[9])
            }
        }
    }
    readTxt();
	document.body.id = "rerq"
    var clipboard = new Clipboard('#rerq');
